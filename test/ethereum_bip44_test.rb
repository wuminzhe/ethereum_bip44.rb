...
class EthereumBip44Test < Minitest::Test
  ...
  def test_get_addresses_from_wallet
    ...
    first_wallet = EthereumBip44::Wallet.new(seed, 0)
    first_address = first_wallet.get_address(0)
  ...
  def test_create_wallet_from_mnemonic
    ...
    first_wallet = EthereumBip44::Wallet.create_from_mnemonic(words, 0)
    first_address = first_wallet.get_address(0)
  ...
  def test_it_can_create_a_new_ethereum_address_from_mnemonic
    ...
    address = EthereumBip44::Utils.prefix_hex(address)
